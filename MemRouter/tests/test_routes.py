...
class RouteTests(unittest.TestCase):
    def test_route_slugifies_ascii_user_id(self) -> None:
        ...
        self.assertEqual(route["path"], "MemRouter/users/a-l/preferences.md")
    ...
    def test_route_preserves_unicode_user_id(self) -> None:
        ...
        self.assertEqual(route["path"], "MemRouter/users/张三/preferences.md")
    ...
    def test_route_preserves_unicode_project_slug(self) -> None:
        ...
        self.assertEqual(route["path"], "MemRouter/projects/研究项目/facts.md")
    ...
    def test_route_slugifies_ascii_project_name(self) -> None:
        ...
        self.assertEqual(route["path"], "MemRouter/projects/demo-project/facts.md")
