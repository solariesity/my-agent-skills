...
file-router follows semantic versioning in spirit. `v1.0.0` is a pre-1.0 release; the CLI surface and routing policies may still evolve as usage patterns become clearer.
