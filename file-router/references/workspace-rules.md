...
Use this file when you need the underlying storage rules that file-router follows.
file-router applies these rules under a local `files/` directory in the current working directory.
