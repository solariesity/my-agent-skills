...
Use this file when file-router is being applied directly inside an agent workflow.

## Default Storage Root

Unless another workspace root is explicitly supplied, file-router stores everything under:
