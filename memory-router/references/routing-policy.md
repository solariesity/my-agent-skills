...
Use this file when you need the exact folder layout, naming rules, or retrieval scope for memory-router.
...
If the workspace already has a legacy memory system, migrate durable memory into the configured memory-router root before writing new long-term memory.
After that handoff, memory-router becomes the canonical durable-memory location for the workspace.
...
- `profile`
  - `memory-router/users/<user_id>/profile.md`
  - section: `Facts`
- `preferences`
  - `memory-router/users/<user_id>/preferences.md`
  - section: `Entries`
- `task` without project
  - `memory-router/users/<user_id>/tasks.md`
  - section: `Entries`

### Project scope

- `project-facts`
  - `memory-router/projects/<project_slug>/facts.md`
  - section: `Entries`
- `project-decisions`
  - `memory-router/projects/<project_slug>/decisions.md`
  - section: `Entries`
- `task` with project
  - `memory-router/projects/<project_slug>/tasks.md`
  - section: `Entries`

### Session scope

- `session-summary` with project
  - `memory-router/projects/<project_slug>/sessions/<year>/<yyyy-mm-dd>.md`
  - section: `Summary`
- `session-summary` without project
  - `memory-router/sessions/<user_id>/<year>/<yyyy-mm-dd>.md`
  - section: `Summary`

### Inbox scope

- `ephemeral`
  - `memory-router/inbox/<year>/<yyyy-mm-dd>.md`
  - section: `Entries`
...
- extract durable memory and rewrite it into the canonical memory-router routes
...
Do not blindly migrate these into memory-router as raw files:
...
- say that the workspace now uses memory-router for durable memory
...
- say which files still live outside memory-router, such as todos, reminders, or diary files
...
This workspace uses memory-router for durable memory.
