...
memory-router 需要 Python 3.10 或更高版本。

这个 skill 存放在 [`my-agent-skills`](https://github.com/solariesity/my-agent-skills) 集合仓库中。克隆该仓库并进入 memory-router 目录：
...
Windows 上对应路径是 `C:\Users\<用户名>\.codex\skills\memory-router\`。
